...
//!
//! ```rust
//! use casa_tables::{Table, TableSchema, ColumnSchema, table_quantum::TableQuantumDesc};
//! use casa_types::*;
//!
...
impl TableQuantumDesc {
    ...
    ///
    /// ```
    /// use casa_tables::table_quantum::TableQuantumDesc;
    ///
    /// let desc = TableQuantumDesc::with_unit("flux", "Jy");
...
mod tests {
    ...
    fn array_quant_put_writes_array_units_on_empty_row() {
        ...
        // Add an empty row
        table.add_row(casa_types::RecordValue::default()).unwrap();
    ...
    fn array_quant_fixed_multiple_units_roundtrip() {
        ...
        table
            .add_row(casa_types::RecordValue::new(vec![
