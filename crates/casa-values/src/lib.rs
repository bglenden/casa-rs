...
//!
//! ```rust
//! use casa_values::{ArrayValue, RecordField, RecordValue, ScalarValue, Value};
//!
...
///
/// ```rust
/// use casa_values::{PrimitiveType, TypeTag, ValueRank};
///
...
///
/// ```rust
/// use casa_values::{PrimitiveType, ScalarValue};
///
...
///
/// ```rust
/// use casa_values::{ArrayValue, PrimitiveType};
///
...
impl RecordField {
    ...
    ///
    /// ```rust
    /// use casa_values::{RecordField, ScalarValue, Value};
    ///
...
///
/// ```rust
/// use casa_values::{RecordField, RecordValue, ScalarValue, Value};
///
/// let mut record = RecordValue::default();
...
impl RecordValue {
    ...
    ///
    /// ```rust
    /// use casa_values::{RecordValue, ScalarValue, Value};
    ///
    /// let mut record = RecordValue::default();
...
///
/// ```rust
/// use casa_values::{ScalarValue, Value, ValueKind};
///
