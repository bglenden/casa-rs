...
| `tclean` MFS | partial/available | `casa-imaging`, `casars-imager` | `casars-imager`; Python projection includes automask controls | tutorial parameter mapping, pbcor/outlier/startmodel tails | CASA `tclean` image products | imager parity scripts and tutorial timings | #117, #127, #167 |
