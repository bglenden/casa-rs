...
//!
//! ```text
//! cargo run -p casacore-measures-tools --bin import_observatories -- \
//!   --input /path/to/geodetic/Observatories \
//!   --output crates/casacore-measures-data/data/observatories.json
//! ```
//!
...
/// `crates/casacore-measures-data/data/observatories.json`, generated from the
