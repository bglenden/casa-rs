...
| `alma/antennae/band7` | Antennae Band 7 Imaging | 6.6.6 | <https://casaguides.nrao.edu/index.php/AntennaeBand7_Imaging> | `plotms`, `tclean`, `uvcontsub`, `imstat`, `immoments`, `exportfits`, `gaincal`, `applycal`, `rmtables` | ALMA science-verification package; page links support docs more than direct archives | #161 |
