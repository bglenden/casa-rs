...
final class WorkbenchStoreTests: XCTestCase {
    ...
    func testImagerProgressUsesObservabilityResourcesWhenPresent() throws {
        ...
        XCTAssertEqual(executionState.currentSpans.first?.detail, "visibility-grid, plane-state / major_cycle=1, minor_iterations=25")
