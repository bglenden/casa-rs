...
private enum GUIEvidenceCaptureRenderer {
    ...
    private static func renderSplitRun(
        ...
        store.setGenericTaskValue(taskID: "split", argumentID: "ms", value: dataset.path)
        store.setGenericTaskValue(taskID: "split", argumentID: "out", value: "twhya_smoothed.gui.ms")
    ...
    private static func renderImagerParameters(
        ...
        store.setGenericTaskValue(taskID: "imager", argumentID: "cell_arcsec", value: "0.1")
        ...
        store.setGenericTaskValue(taskID: "imager", argumentID: "threshold_jy", value: request.thresholdJy)
