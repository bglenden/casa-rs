    ...
    UiCommandSchema {
        ...
        arguments: vec![
            ...
            option_argument(OptionArgumentConfig {
                ...
                default: None,
                choices: &[],
                help: "CASA outlier-field definitions for supported MFS/Hogbom image sets",
                group: "Products",
                required: false,
                advanced: true,
            }),
            ...
            option_argument(OptionArgumentConfig {
                ...
                help: "MFS continuum imaging, cube with CASA Doppler/frame handling, or cubedata in the native data frame without Doppler correction",
                group: "Stages",
                required: true,
                advanced: false,
            }),
            ...
            option_argument(OptionArgumentConfig {
                ...
                help: "CASA tclean gridder. casa-rs supports standard, wproject, and mosaic; widefield/AW-family modes are visible but not implemented yet.",
                group: "Stages",
                required: true,
                advanced: false,
            }),
            toggle_argument(ToggleArgumentConfig {
                ...
                false_flags: &["--no-perchanweightdensity"],
                default: Some("cube:true,cubedata:false"),
                help: "Use per-output-channel density estimates for cube weighting; CASA defaults this on for specmode=cube and off for cubedata",
                group: "Stages",
                advanced: true,
            }),
            toggle_argument(ToggleArgumentConfig {
            ...
            option_argument(OptionArgumentConfig {
                ...
                default: Some("0"),
                choices: &[],
                help: "Minor-cycle iteration budget; ignored when Dirty Only is enabled",
                group: "Stages",
                required: false,
                advanced: false,
            }),
            ...
            option_argument(OptionArgumentConfig {
                ...
                default: Some("-1"),
                choices: &[],
                help: "Major-cycle limit; -1 keeps CASA's unlimited default",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            toggle_argument(ToggleArgumentConfig {
                ...
                label: "Full Summary",
                order: 35,
                true_flags: &["--fullsummary"],
                false_flags: &[],
                default: Some("false"),
                help: "Include long-form CASA-compatible summaryminor rows",
                group: "Stage Parameters",
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                ...
                default: Some("0.0"),
                choices: &[],
                help: "Absolute CLEAN threshold in Jy/beam; ignored when Dirty Only is enabled",
                group: "Stages",
                required: false,
                advanced: false,
            }),
            ...
            option_argument(OptionArgumentConfig {
                ...
                default: Some("0.2"),
                choices: &[],
                help: "Mosaic primary-beam cutoff for flat-noise normalization",
                group: "Stages",
                required: false,
                advanced: true,
            }),
            toggle_argument(ToggleArgumentConfig {
                id: "write_pb",
                label: "Primary Beam Image",
                order: 53,
                true_flags: &["--write-pb"],
                false_flags: &[],
                default: Some("false"),
                help: "Write the primary-beam image used for PB correction",
                group: "Stages",
                advanced: true,
            }),
            toggle_argument(ToggleArgumentConfig {
            ...
            option_argument(OptionArgumentConfig {
                ...
                value_kind: UiValueKind::Choice,
                default: Some("user"),
                choices: &["user", "auto-multithresh"],
                help: "Clean-mask generation mode",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                id: "sidelobethreshold",
                label: "Sidelobe Threshold",
                order: 44,
                flags: &["--sidelobethreshold"],
                metavar: "VALUE",
                value_kind: UiValueKind::Float,
                default: Some("3.0"),
                choices: &[],
                help: "Auto-multithresh sidelobe threshold factor",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                ...
                order: 45,
                flags: &["--noisethreshold"],
                metavar: "VALUE",
                value_kind: UiValueKind::Float,
                default: Some("5.0"),
                choices: &[],
                help: "Auto-multithresh noise threshold factor",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                id: "lownoisethreshold",
                label: "Low Noise Threshold",
                order: 46,
                flags: &["--lownoisethreshold"],
                metavar: "VALUE",
                value_kind: UiValueKind::Float,
                default: Some("1.5"),
                choices: &[],
                help: "Auto-multithresh mask-growth threshold factor",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                ...
                order: 47,
                flags: &["--negativethreshold"],
                metavar: "VALUE",
                value_kind: UiValueKind::Float,
                default: Some("0.0"),
                choices: &[],
                help: "Auto-multithresh negative-feature threshold factor",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                ...
                default: Some("0.3"),
                choices: &[],
                help: "Auto-multithresh pruning region size as a beam fraction",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
            option_argument(OptionArgumentConfig {
                ...
                order: 49,
                flags: &["--growiterations"],
                metavar: "N",
                value_kind: UiValueKind::String,
                default: Some("75"),
                choices: &[],
                help: "Auto-multithresh constrained mask-growth iterations",
                group: "Stage Parameters",
                required: false,
                advanced: true,
            }),
...
mod tests {
    ...
    #[test]
    fn schema_defaults_match_cli_runtime_defaults_for_advanced_controls() {
        let schema = command_schema("casars-imager");
