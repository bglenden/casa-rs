...
pub struct PointingDirectionQuery {
    antenna_id: i32,
...
impl PointingDirectionQuery {
    ...
    pub fn new(antenna_id: i32, time_mjd_seconds: f64) -> MsResult<Self> {
    ...
    #[must_use]
    pub const fn antenna_id(self) -> i32 {
        self.antenna_id
    }
...
impl PointingReadPlan {
    ...
    pub fn new(scan_rows_per_block: usize, maximum_polynomial_terms: usize) -> MsResult<Self> {
    ...
    /// Return the maximum scalar POINTING rows scanned simultaneously.
    #[must_use]
    pub const fn scan_rows_per_block(self) -> usize {
        self.scan_rows_per_block
    }

    /// Return the maximum accepted polynomial coefficient count per axis.
    #[must_use]
    pub const fn maximum_polynomial_terms(self) -> usize {
        self.maximum_polynomial_terms
    }
}

/// One evaluated J2000 POINTING candidate.
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct PointingDirectionCandidate {
    row_index: usize,
...
impl PointingDirectionCandidate {
    ...
    #[must_use]
    pub const fn row_time_mjd_seconds(self) -> f64 {
        self.row_time_mjd_seconds
    }

    /// Return the evaluated J2000 direction in radians.
    #[must_use]
    pub const fn direction_j2000_rad(self) -> [f64; 2] {
...
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct PointingDirectionBracket {
...
impl PointingDirectionBracket {
    ...
    #[must_use]
    pub const fn covering(self) -> Option<PointingDirectionCandidate> {
        self.covering
    }

    /// Return the closest row at or before the query epoch.
    #[must_use]
    pub const fn before(self) -> Option<PointingDirectionCandidate> {
        self.before
    }

    /// Return the closest row at or after the query epoch.
    #[must_use]
    pub const fn after(self) -> Option<PointingDirectionCandidate> {
        self.after
    }
}
...
impl MeasurementSet {
    ...
    pub fn pointing_direction_brackets(
        &self,
        engine: &MsCalEngine,
