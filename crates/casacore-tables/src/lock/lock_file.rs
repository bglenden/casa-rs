...
impl LockFile {
    ...
    pub fn create_or_open(
        ...
        let _ = fcntl_lock(fd, libc::F_SETLK, libc::F_RDLCK, 1, use_len);
    ...
    pub fn release(&mut self) -> io::Result<bool> {
        ...
        fcntl_lock(self.fd, libc::F_SETLK, libc::F_UNLCK, 0, 1)?;
    ...
    pub fn is_multi_used(&self) -> bool {
        ...
        !fcntl_lock(self.fd, libc::F_SETLK, libc::F_WRLCK, 1, 1).unwrap_or(true)
    }
...
fn fcntl_lock(fd: RawFd, cmd: i32, lock_type: i16, start: i64, len: i64) -> io::Result<bool> {
