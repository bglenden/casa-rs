...
//!
//! ```rust
//! use casa_types::{ScalarValue, ArrayValue, RecordField, RecordValue, Value};
//!
...
///
/// ```rust
/// use casa_types::{TypeTag, PrimitiveType, ValueRank};
///
...
///
/// ```rust
/// use casa_types::{ScalarValue, PrimitiveType};
///
...
///
/// ```rust
/// use casa_types::{ArrayValue, PrimitiveType};
///
...
///
/// ```rust
/// use casa_types::{RecordValue, RecordField, ScalarValue, Value};
///
/// let mut record = RecordValue::default();
...
///
/// ```rust
/// use casa_types::{Value, ScalarValue, ValueKind};
///
