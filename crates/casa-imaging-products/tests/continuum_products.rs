...
fn v2_commitments_stay_pinned_and_v3_adds_exact_taylor_identity() {
    const CONSTANT_DIGEST: [u8; 32] = [
        0x08, 0x44, 0xbf, 0xb9, 0x05, 0x3c, 0xa3, 0x72, 0x40, 0x91, 0x79, 0x6e, 0xc8, 0x30, 0x13,
        0x2d, 0x7d, 0xdd, 0x60, 0x29, 0xcf, 0xbf, 0x1b, 0xa9, 0x06, 0x7c, 0xf9, 0x0e, 0xfc, 0xc1,
        0x1a, 0x7c,
    ];
    const CHANNEL_DIGEST: [u8; 32] = [
        0xde, 0x83, 0x4d, 0x17, 0x52, 0xb7, 0x2c, 0x45, 0x4a, 0x3f, 0xab, 0xf7, 0x1a, 0x51, 0x00,
        0xf3, 0x65, 0xe3, 0x4a, 0x03, 0xa9, 0x00, 0x8b, 0x8b, 0x18, 0x85, 0xb4, 0x99, 0xff, 0x3d,
        0x8e, 0x6c,
    ];
    const CONSTANT_V3_DIGEST: [u8; 32] = [
        0x48, 0x5b, 0xa2, 0x5d, 0x16, 0x71, 0x4a, 0xb4, 0xf3, 0x5e, 0x8b, 0x29, 0x68, 0x6a, 0x2c,
        0x8a, 0x37, 0xfc, 0xe0, 0x4f, 0x0b, 0x30, 0xf8, 0x53, 0xb1, 0xef, 0x62, 0xf4, 0x79, 0xd5,
        0xda, 0xe5,
    ];
    const CHANNEL_V3_DIGEST: [u8; 32] = [
        0x4f, 0x3a, 0x2c, 0xb1, 0xb1, 0x9c, 0x91, 0x08, 0x32, 0x53, 0x28, 0x94, 0x05, 0x68, 0xe7,
        0xe4, 0x93, 0x0d, 0x54, 0x49, 0x2a, 0xa1, 0x73, 0xa7, 0x0e, 0x14, 0xc3, 0x36, 0xd9, 0x2a,
        0x8e, 0xb9,
    ];
    const TAYLOR_V3_DIGEST: [u8; 32] = [
        0xc4, 0x46, 0x77, 0xd3, 0xcf, 0x9c, 0x0e, 0x85, 0xed, 0x1a, 0x86, 0xf9, 0xef, 0xda, 0x24,
        0x60, 0x19, 0xce, 0x1f, 0xbf, 0x70, 0x4b, 0x83, 0x01, 0xb8, 0x06, 0x3e, 0xd0, 0xea, 0x91,
        0xab, 0xa2,
    ];
