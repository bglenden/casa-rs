...
//!
//! ```sh
//! cargo run --example t_lattice_statistics -p casa-lattices --release
//! ```
//!
//! ## Missing C++ functions added for this demo
//!
//! The following utilities mirror C++ `ArrayMath.h` functions absent from
//! ndarray and are now available in `casa_lattices::array_math`:
//!
//! | Rust                   | C++ equivalent               |
//! |------------------------|------------------------------|
...
fn scalar<T: casa_lattices::StatsElement>(stats: &LatticeStatistics<T>, stat: Statistic) -> f64 {
