        ...
        Value::Array(av) => {
            ...
            let out = match target_type {
                PrimitiveType::Float32 => {
                    casa_types::ArrayValue::Float32(scaled.mapv(|x| x as f32))
                }
                _ => casa_types::ArrayValue::Float64(scaled),
            };
            Ok(Value::Array(out))
        }
...
fn apply_complex_scale_offset(
    ...
    match target_type {
        PrimitiveType::Complex32 => {
            ...
            Ok(Value::Array(casa_types::ArrayValue::Complex32(arr)))
        }
        PrimitiveType::Complex64 => {
            ...
            Ok(Value::Array(casa_types::ArrayValue::Complex64(arr)))
        }
...
fn array_to_f64(av: &casa_types::ArrayValue) -> Result<ArrayD<f64>, StorageError> {
