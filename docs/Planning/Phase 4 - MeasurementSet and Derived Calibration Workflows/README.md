...
This file is retained as historical process context for archived Phase 4 wave
...
While Phase 4 was active, wave file names were used as the local status model:
