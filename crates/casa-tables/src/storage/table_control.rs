...
impl TableDatContents {
    ...
    pub(crate) fn from_snapshot_with_virtual(
        ...
        use casa_types::{RecordField, ScalarValue, Value};
...
fn scaled_array_dm_type_name(schema: &TableSchema, virtual_col: &str, stored_col: &str) -> String {
    ...
    let vtype_str = match vtype {
        Some(casa_types::PrimitiveType::Float32) => "float   ",
        Some(casa_types::PrimitiveType::Float64) => "double  ",
        Some(casa_types::PrimitiveType::Complex32) => "Complex ",
        Some(casa_types::PrimitiveType::Complex64) => "DComplex",
        _ => "double  ",
    };
    let stype = schema
        .columns()
    ...
    let stype_str = match stype {
        Some(casa_types::PrimitiveType::Int16) => "Short   ",
        Some(casa_types::PrimitiveType::Int32) => "Int     ",
        Some(casa_types::PrimitiveType::Int64) => "Int64   ",
        Some(casa_types::PrimitiveType::UInt8) => "uChar   ",
        Some(casa_types::PrimitiveType::UInt16) => "uShort  ",
        Some(casa_types::PrimitiveType::UInt32) => "uInt    ",
        Some(casa_types::PrimitiveType::Float32) => "float   ",
        Some(casa_types::PrimitiveType::Float64) => "double  ",
        _ => "Int     ",
    };
