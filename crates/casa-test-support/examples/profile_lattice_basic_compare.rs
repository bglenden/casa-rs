...
//!
//! Usage:
//! `cargo run --release -p casa-test-support --example profile_lattice_basic_compare -- rust`
//! `cargo run --release -p casa-test-support --example profile_lattice_basic_compare -- cpp`
//!
//! Environment:
