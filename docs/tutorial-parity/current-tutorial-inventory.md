...
| `alma/m100/band3-combine` | M100 Band 3 Combine | mixed page history, current ALMA topical | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine> | `listobs`, `tclean`, `split`, `imhead`, `imstat`, `immoments`, `exportfits`, `imregrid`, `immath`, `imsubimage`, image tool `ia.open` | ALMA science-verification calibrated data and `M100_Band3_DataComb_ReferenceImages_5.1.tgz` | #163 |
...
| `alma/automasking` | Automasking Guide | 6.5.4 / 6.6.x topical | <https://casaguides.nrao.edu/index.php?title=Automasking_Guide_CASA_6.5.4> | `listobs`, `tclean` with `usemask='auto-multithresh'`, `noisethreshold`, `sidelobethreshold`, `lownoisethreshold`, `minbeamfrac`, `negativethreshold`, `fastnoise` | `twhya_selfcal.ms.contsub.tar`; expected products include `twhya_dirtycube.{image,residual,psf,sumwt}`, automasked cube image/residual/mask products such as `twhya_base_params.{image,residual,mask}`, and parameter-variation image/residual/mask products | #167 |
...
| `vla/imaging` | VLA CASA Imaging | 6.5.4 current scripted source; 6.7.2 guide family | <https://casaguides.nrao.edu/index.php?title=VLA_CASA_Imaging-CASA6.5.4> | `tclean`, legacy `clean`, `impbcor`, `widebandpbcor`, `imhead`, `immath`, image tool `ia.open`, `rmtables` | `SNR_G55_10s.calib.tar.gz`, official noninteractive script archive | #175 |
...
| `vla/imaging` | legacy `clean` comparison products where referenced, `tclean` image sidecars including `.pb`, regular and wideband PB-corrected products, outlier field images, header/math products |
...
| `alma/automasking/contsub-ms` | <https://casaguides.nrao.edu/index.php?title=Automasking_Guide_CASA_6.5.4> | <https://bulk.cv.nrao.edu/almadata/public/casaguides/Automasking_Guide/twhya_selfcal.ms.contsub.tar> | `twhya_selfcal.ms.contsub.tar` | 257537974 bytes | SHA-256 `9cd1b5f9a3bc80a5758e945d1c398e79a64fec9e2d40cad4336edbe7ea787de6` | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/automasking/twhya_selfcal.ms.contsub.tar` | #167 |
...
| `alma/first-look/twhya/n2hp-image` | <https://casaguides.nrao.edu/index.php/First_Look_at_Image_Analysis> | <https://bulk.cv.nrao.edu/almadata/public/ALMA_firstlooks/twhya_n2hp.image> | `twhya_n2hp.image` | 3978770 bytes | directory SHA-256 manifest in local mirror; expected default mask `mask0` | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/first-look/twhya/twhya_n2hp.image` | #140 |
...
| `alma/m100/band3-combine/12m-calibrated-data` | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine_6.6.6> | <https://almascience.nrao.edu/almadata/sciver/M100Band3_12m/M100_Band3_12m_CalibratedData.tgz> | `M100_Band3_12m_CalibratedData.tgz` | 15580494468 bytes | not advertised; compute at mirror completion | slow-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/m100/band3-combine/raw/M100_Band3_12m_CalibratedData.tgz` | #163 |
| `alma/m100/band3-combine/7m-calibrated-data` | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine_6.6.6> | <https://almascience.nrao.edu/almadata/sciver/M100Band3ACA/M100_Band3_7m_CalibratedData.tgz> | `M100_Band3_7m_CalibratedData.tgz` | 9774558254 bytes | not advertised; compute at mirror completion | slow-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/m100/band3-combine/raw/M100_Band3_7m_CalibratedData.tgz` | #163 |
| `alma/m100/band3-combine/tp-calibrated-data` | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine_6.6.6> | <https://almascience.nrao.edu/almadata/sciver/M100Band3ACA/M100_Band3_TP_CalibratedData_5.1.tgz> | `M100_Band3_TP_CalibratedData_5.1.tgz` | 14372792248 bytes | not advertised; compute at mirror completion | slow-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/m100/band3-combine/raw/M100_Band3_TP_CalibratedData_5.1.tgz` | #163 |
| `alma/m100/band3-combine/aca-reference-images` | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine_6.6.6> | <https://almascience.nrao.edu/almadata/sciver/M100Band3ACA/M100_Band3_ACA_ReferenceImages_5.1.tgz> | `M100_Band3_ACA_ReferenceImages_5.1.tgz` | 24775689 bytes | not advertised; compute at mirror completion | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/m100/band3-combine/raw/M100_Band3_ACA_ReferenceImages_5.1.tgz` | #163 |
| `alma/m100/band3-combine/reference-images` | <https://casaguides.nrao.edu/index.php/M100_Band3_Combine> | <https://almascience.nrao.edu/almadata/sciver/M100Band3ACA/M100_Band3_DataComb_ReferenceImages_5.1.tgz> | `M100_Band3_DataComb_ReferenceImages_5.1.tgz` | 411602337 bytes | SHA-256 `04e3e88f1393e93c18eab7fd4a9ae5c57e768dbb8be85259c3006ae9d4c7634b` | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/alma/m100/band3-combine/M100_Band3_DataComb_ReferenceImages_5.1.tgz` | #163 |
...
| `vla/3c391/raw-10s-spw0` | <https://casaguides.nrao.edu/index.php?title=VLA_Continuum_Tutorial_3C391-CASA6.4.1> | <https://casa.nrao.edu/Data/EVLA/3C391/3c391_ctm_mosaic_10s_spw0.ms.tgz> | `3c391_ctm_mosaic_10s_spw0.ms.tgz` | 221474816 bytes | SHA-256 `03e36442d56607f48caa6061713bf138ec38348c1bcb8cce11ddaba16af70f7d` | slow-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/vla/3c391/3c391_ctm_mosaic_10s_spw0.ms.tgz` | #169 |
| `vla/3c391/final-calibrated-mosaic-ms` | <https://casaguides.nrao.edu/index.php?title=VLA_Continuum_Tutorial_3C391-CASA6.4.1> | <https://casa.nrao.edu/Data/EVLA/3C391/EVLA_3C391_FinalCalibratedMosaicMS.tgz> | `EVLA_3C391_FinalCalibratedMosaicMS.tgz` | 1410442215 bytes | SHA-256 `c9084b2794d4b39ebab17f03a97f9b3a3a61717e8d76118f09c1e2d99e0c5268` | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/vla/3c391/EVLA_3C391_FinalCalibratedMosaicMS.tgz` | #169 |
| `vla/imaging/calibrated-ms` | <https://casaguides.nrao.edu/index.php?title=VLA_CASA_Imaging-CASA6.5.4> | <https://casa.nrao.edu/Data/EVLA/SNRG55/SNR_G55_10s.calib.tar.gz> | `SNR_G55_10s.calib.tar.gz` | 1250616054 bytes | SHA-256 `b79a63d1142674c89c4c3ae702a28625867728a420a3c156e0ec44078200bf6a` | tutorial-parity | `${CASA_RS_TUTORIAL_DATA_ROOT}/tutorial-parity/vla/imaging/SNR_G55_10s.calib.tar.gz` | #175 |
