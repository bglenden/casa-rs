...
| Python | `casars.tasks.imager` | `vis="twhya_calibrated.ms"`, `imagename=".casa-rs/workspace/native/05-phase-cal-clean/phase_cal_clean.python"`, `imsize=250`, `cell="0.1arcsec"`, `field="3"`, `phasecenter_field="3"`, `weighting="briggs"`, `robust=0.5`, `deconvolver="hogbom"`, `niter=10000`, `threshold="0.015Jy"`, `pblimit=0.2`, `write_pb=True`, `dirty_only=False`, `mask_box="100,100,150,150"` |
...
<tr><td>Python</td><td><code>casars.tasks.imager</code></td><td><code>field=3</code>, <code>phasecenter_field=3</code>, <code>niter=10000</code>, <code>threshold=0.015Jy</code>, <code>pblimit=0.2</code>, <code>write_pb=True</code>, <code>mask_box=100,100,150,150</code></td></tr>
