...
macro_rules! define_generic_subtable {
    (
        ...
        pub struct $read_ty<'a> {
            table: &'a casa_tables::Table,
        }

        impl<'a> $read_ty<'a> {
            /// Wrap an existing table as this MS subtable.
            pub fn new(table: &'a casa_tables::Table) -> Self {
                Self { table }
            }
            ...
            pub fn table(&self) -> &casa_tables::Table {
                self.table
            }
            ...
            pub fn array(&self, row: usize, col: &str) -> crate::MsResult<&casa_types::ArrayValue> {
            ...
            pub fn optional_array(
                ...
                row: usize,
                col: &str,
            ) -> crate::MsResult<Option<&casa_types::ArrayValue>> {
        ...
        impl crate::subtables::SubTable for $read_ty<'_> {
            ...
            fn table(&self) -> &casa_tables::Table {
                self.table
            }
        }
        ...
        pub struct $write_ty<'a> {
            table: &'a mut casa_tables::Table,
        }

        impl<'a> $write_ty<'a> {
            /// Wrap an existing mutable table as this MS subtable.
            pub fn new(table: &'a mut casa_tables::Table) -> Self {
                Self { table }
            }
            ...
            pub fn table_mut(&mut self) -> &mut casa_tables::Table {
                self.table
            }
            ...
            pub fn set_i32(&mut self, row: usize, col: &str, value: i32) -> crate::MsResult<()> {
                crate::subtables::set_scalar(
                    ...
                    row,
                    col,
                    casa_types::ScalarValue::Int32(value),
                )
            }
            ...
            pub fn set_f64(&mut self, row: usize, col: &str, value: f64) -> crate::MsResult<()> {
                crate::subtables::set_scalar(
                    ...
                    row,
                    col,
                    casa_types::ScalarValue::Float64(value),
                )
            }
            ...
            pub fn set_bool(&mut self, row: usize, col: &str, value: bool) -> crate::MsResult<()> {
                crate::subtables::set_scalar(
                    ...
                    row,
                    col,
                    casa_types::ScalarValue::Bool(value),
                )
            }
            ...
            pub fn set_string(
                ...
                crate::subtables::set_scalar(
                    ...
                    row,
                    col,
                    casa_types::ScalarValue::String(value.into()),
                )
            }
